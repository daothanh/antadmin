...
khớp `.env.example`, `CLAUDE.md` của template và docs Auth. `NUXT_OIDC_MOCK` chỉ còn tác dụng với phần OIDC sót lại
(refresh token, logout), nên làm theo hướng dẫn cũ vẫn phải đăng nhập IAM thật.
